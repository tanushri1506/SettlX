...
export default function Home() {
  return (
    <div className="flex flex-col pt-16">
      <section className="mt-20 pb-12 space-y-10 md:space-y-20 px-5">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          <Badge variant="outline" className="bg-blue-100 text-blue-700">
            Track. Split. Settle. Effortlessly.
          </Badge>

          <h1 className="gradient-title mx-auto max-w-4xl text-4xl font-bold md:text-7xl">
            The simplest way to split and settle bills
          </h1>

          <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl/relaxed">
            Shared dinner? Group trip? We’ll handle the math — you handle the memories
          </p>
      ...
      {/* ───── Footer ───── */}
      <footer className="border-t bg-gray-50 py-5 text-center text-sm text-muted-foreground">
        © {new Date().getFullYear()} SettlX. All rights reserved.
      </footer>
